...
class ServiceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'remaining_sessions', 'owner', 'owner_email', 'latitude', 'longitude', 'city', 'zip_code'
        ]
        read_only_fields = ['id', 'created_at', 'owner', 'owner_email', 'average_rating', 'remaining_sessions', 'is_available', 'latitude', 'longitude', 'city', 'zip_code']
